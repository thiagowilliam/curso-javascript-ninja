...
*/
var myarray = [10, "Thiago", null, { a: 1 }, function() {}];
...
var myArray2 = [44.4, "Ana", true, { b: 2, c: 4 }, [1, 2, 3, 4, "Testando"]];
...
console.log(
  "O livro " +
    bookName +
    " tem " +
    book(bookName).quantidadesPaginas +
    " páginas!"
);
