...
*/
person.toWalk = function(metros){
  person.walkingHowManyMeters += metros;
  person.walking = true;
};
/*
...
person.fullName = function(){
  return 'Hi! My name is ' + person.firstname +' '+ person.surename +' ! ';
};
...
*/
person.showOld = function(){
  return 'Hi, I am ' + person.old + ' years old !'
};
